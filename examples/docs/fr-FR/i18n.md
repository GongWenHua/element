...
import locale from 'snow-element-ui/lib/locale/lang/en'
...
import lang from 'snow-element-ui/lib/locale/lang/en'
import locale from 'snow-element-ui/lib/locale'
...
{
  plugins: [
    new webpack.NormalModuleReplacementPlugin(/element-ui[\/\\]lib[\/\\]locale[\/\\]lang[\/\\]zh-CN/, 'snow-element-ui/lib/locale/lang/en')
  ]
}
```
...
import enLocale from 'snow-element-ui/lib/locale/lang/en'
import zhLocale from 'snow-element-ui/lib/locale/lang/zh-CN'
...
import enLocale from 'snow-element-ui/lib/locale/lang/en'
import zhLocale from 'snow-element-ui/lib/locale/lang/zh-CN'
import ElementLocale from 'snow-element-ui/lib/locale'
