...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'snow-element-ui/src/utils/date-util';
  import ElScrollbar from 'snow-element-ui/packages/scrollbar';
  import RepeatClick from 'snow-element-ui/src/directives/repeat-click';
